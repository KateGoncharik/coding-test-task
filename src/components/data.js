...
const requiredInputsData = [
  { name: 'org-name', placeholder: 'АВЦ', className: 'form-input', type: 'text' },
  { name: 'telephone', placeholder: '+7 933 848-34-33', className: 'form-input', type: 'tel' },
  { name: 'email', placeholder: 'avc@gmail.com', className: 'form-input', type: 'email' },
];
